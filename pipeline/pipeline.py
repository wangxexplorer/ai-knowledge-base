...
from model_client import chat_with_retry, enable_cost_tracking, get_provider

import model_client as mc  # 模块引用，动态获取 cost_tracker
...
def run_pipeline(
    ...
    if mc.cost_tracker is not None:
        mc.cost_tracker.report()
